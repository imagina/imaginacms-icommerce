<div class="card card-block order p-3 mb-3">
    <div class="row">
        <div class="col">
                    ...
                    <div class="row item_carting px-3 w-100 m-0" v-for="item in items">
                        <div class="col-3 pr-0 pb-2">
                            <a v-if="item.mainimage != null" v-bind:href="item.slug" class="cart-img float-left">
                                <img v-if="item.mainimage != null" class="img-fluid" v-bind:src="item.mainimage" v-bind:alt="item.name">
                                <img v-else class="img-fluid" src="http://local.imagina.com.co:82/labs/appstrap3.0.11/theme/assets/img/shop/gloves-1-thumb.jpg" v-bind:alt="item.name">
                            </a>
                        </div>
                        <div class="col-9">
                            <a class="close cart-remove text-primary float-right" v-on:click="deleteItem(item)"> <i class="fa fa-times"></i> </a>
                            <h5 class="mb-0">
                                @{{ item.name }}
                            </h5>
                            <p class="mb-0">
                    ...
                    <div class="dropdown-footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                <p>
                                    <div v-if="!updatingData">
                                        <div v-if="shipping_method!='freeshipping' && shipping==0">
                                            {{ trans('icommerce::order_summary.shipping_cero')}}
                                        </div>
                                        <div v-else>
                        ...
                        <input type="hidden" name="tax_amount" v-model="tax_total">
                    </div>
            ...
            <button type="button" class="btn btn-warning btn-lg w-100 mt-3 placeOrder" @click="submitOrder($event)" :disabled="placeOrderButton || updatingData"> 
