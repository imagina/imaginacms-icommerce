<div class="card-ckeckout card-delivery-details mb-3">
    ...
    <div class="collapse border-0" id="collapseShippingAddress">
    <div id="ShippingAddress" >
        ...
        <div class="card-block" >
            ...
            <div class="card mb-0 border-0" v-if="user && user.addresses">
                ...
                <div id="collapseExistingShipping"
                     :class="useExistingOrNewShippingAddress==1 ? 'py-4 collapse in show' : 'py-4 collapse'"
                ...
                <div id="shippingAddressResume" class="card p-2" v-if="shippingAddress">
                    ...
                    <p class="card-text m-0"><b>{{trans("iprofile::addresses.form.city")}}:</b>
                        @{{shippingAddress.city}}</p>
                    <p class="card-text m-0"><b>{{trans("iprofile::addresses.form.state")}}:</b>
                        @{{shippingAddress.state}}</p>
                        ...
                        @if($extraField->active)
                            @if($extraField->type == "documentType")
                                <p class="card-text m-0"
                                   v-if="shippingAddress.options && shippingAddress.options.identification">
                                    <b>{{trans("iprofile::addresses.form.identification")}}:</b>
                                    @{{shippingAddress.options.identification || '-'}}</p>
                                <p class="card-text m-0"
                                   v-if="shippingAddress.options && shippingAddress.options.documentNumber">
                                    <b>{{trans("iprofile::addresses.form.documentNumber")}}:</b>
                                    @{{shippingAddress.options.documentNumber || '-'}}</p>
                            @else
                                <p class="card-text m-0"
                                   v-if="shippingAddress.options && shippingAddress.options.{{$extraField->field}}">
                                    <b>{{trans("iprofile::addresses.form.$extraField->field")}}:</b>
                                    @{{shippingAddress.options[@php echo "'".$extraField->field."'"; @endphp ] || '-'}}
                                </p>
                            @endif
                        @endif
                    @endforeach
            ...
            <div class="card mb-0 border-0">
                ...
                <div id="collapseNewShipping" :class="addresses ? 'py-3 collapse' : ' py-3 collapse show'"
                     aria-labelledby="useNewShipping"
                     role="tabpanel">
                    ...
                    <div class="form-group row">
                        <div class="col pr-1">
                            ...
                            <input type="text"
                                   :class="'form-control '+ ($v.shippingData.firstname.$error ? 'is-invalid' : '')"
                        ...
                        <div class="col pl-1">
                            ...
                            <input type="text"
                                   :class="'form-control '+ ($v.shippingData.lastname.$error ? 'is-invalid' : '')"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               :class="'form-control '+ ($v.shippingData.address_1.$error ? 'is-invalid' : '')"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               :class="'form-control '+ ($v.shippingData.telephone.$error ? 'is-invalid' : '')"
                    ...
                    <div class="form-group">
                        ...
                        <select
                            ...
                            <option v-for="country in countries" v-bind:value="country.iso_2">@{{ country.name }}
                            </option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select :class="'form-control '+ ($v.shippingData.zoneIndex.$error ? 'is-invalid' : '')"
                            ...
                            <option v-for="state in statesDelivery" v-bind:value="state.iso_2">@{{ state.name }}
                            </option>
                            ...
                            <div class="form-group">
                                ...
                                @if( !in_array($extraField->type, ["select","textarea"]) )
                                    ...
                                    @if($extraField->type == "documentType")
                                        ...
                                        <select id="delivery{{$extraField->field}}"
                    ...
                    <div class="form-group text-center pt-3">
                        <button type="button" class="btn btn-primary" @click="addAddress('shipping')" name="button">
                            Agregar
                            dirección
                        </button>
                    </div>
