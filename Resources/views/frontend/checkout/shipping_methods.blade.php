    ...
    <div class="row">
        <div class="col">
            ...
            <table class="table my-2">
                <tbody>
                    <tr class="shipping-item" v-for="(ship, index) in shipping_methods">
                        <td v-if="ship.configName!=='freeshipping' && ship.configName!=='flatrate' && ship.configName!=='localdelivery' && ship.configName!=='iagree' " colspan="3">
                            ...
                            <div v-if="ship.msj!=='error' && ship.msj!=='freeshipping'" :id="'shipping'+index" class="collapse" role="tabpanel" :aria-labelledby="'shipping'+index">
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td width="90">
                                                <label>
                                                    <input type="radio" @click="calculate(item.price,ship.configName,$event)" class="" v-model="shipping_method" :value="item.configName" id="shipping_method">
                        ...
                        <td v-else width="90">   
                                ...
                                <input 
                                    ...
                                    @click="calculate(ship.deliveryfee,ship.feetype,$event)" 
                                ...
                                <input 
                                    ...
                                    @click="calculate(ship.minimum,ship.configName,$event)" 
                                    v-model="shipping_method" 
                                    ...
                                    <input
                                      ...
                                      type="radio"
                                      v-else-if="ship.cost"
                                      @click="calculate(ship.cost,ship.configName,$event)"
                                      v-model="shipping_method"
                                      :value="ship.configName"
                                      id="shipping_method">
                                    ...
                                    <input
                                      class="w-25 float-left"
                                      type="radio"
                                      v-else-if="ship.configName=='iagree'"
                                      @click="calculate(0,ship.configName,$event)"
                                      v-model="shipping_method"
                                      :value="ship.configName"
                                      id="shipping_method">
                                ...
                                <div class="w-75 float-left iagree" v-else>@{{ship.price | twoDecimals}}</div>
                                
                                </label>
                             
                        </td>
                        <td v-if="ship.configName!=='ups' && ship.configName!=='usps' && ship.configName!=='notmethods' && ship.configName!=='iagree'">
                            ...
                            <div v-else-if="ship.feetype && ship.feetype=='fixed_amount'">{{ trans('icommerce::shipping.form.fixed_amount') }}</div>
                            <div v-else-if="ship.feetype && ship.feetype=='percentage_cart'">{{ trans('icommerce::shipping.form.percentage_cart') }}</div>
                            <div v-else-if="ship.feetype && ship.feetype=='fixed_amount_product'">{{ trans('icommerce::shipping.form.fixed_amount_prod') }}</div>
                        </td>
                        <td v-if="ship.configName!=='ups' && ship.configName!=='usps' && ship.configName!=='notmethods'">
