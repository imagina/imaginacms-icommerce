<div class="infor text-{{ $contentAlign }}">
  ...
  @if (!$viewButtonsWhitOptionsProduct)
    <div class="row align-items-center">
      ...
      @if (
          (!$addToCartWithQuantity || $withTextInAddToCart) &&
              !Str::contains($buttonsPosition, 'in-photo') &&
              !Str::contains($buttonsPosition, 'after-content'))
