@if($product->price>0 && $product->stock_status && $product->quantity)
  <div class="row add-to-cart-with-quantity">
    ...
    <div class="add-to-cart-button">
      <a wire:click="$emit('addCartWithQuantity',$event)" class="btn btn-primary add-to-cart-with-quantity-button"
         data-pid="{{$product->id}}">
    ...
    @if(setting("icommerce::showButtonToQuoteInStore"))
      <div class="add-to-cart-quote-button">
        <a wire:click="$emit('addCartQuoteWithQuantity',$event)"
           class="btn btn-primary add-to-cart-quote-with-quantity-button"
           data-pid="{{$product->id}}">
