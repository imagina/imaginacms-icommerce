  ...
  <div class="col no-padding">
    <div class="row m-0 add-to-cart-with-quantity {{$buttonsLayout}} align-items-center justify-content-between"
      ...
      <div class="elem-buttom number-input input-group quantity-selector">
        ...
        <input aria-label="quantity" type="number" step="1" value="1" min="1" name="quantity"
               class="quantity-field d-inline-block form-control">
      ...
      <!-- BUTTON ADD  -->
      <div
        class="elem-buttom add-to-cart-button buttons {{$buttonsLayout}} {{$buttonsPosition}} {{$withTextInAddToCart ? "with-add-cart-text" : "without-add-cart-text"}} text-xs-center text-md-right">
...
@else
  ...
  @if($product->is_sold_out)
    <div
      class="buttons {{$buttonsLayout}} {{$buttonsPosition}} {{$withTextInAddToCart ? "with-add-cart-text" : "without-add-cart-text"}} my-3">
