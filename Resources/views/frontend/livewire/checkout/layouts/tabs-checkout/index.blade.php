        ...
        <div class="tab-content">
            ...
            <div class="text-right">
              ...
              @auth
                <button type="button" class="btn btn-dark next-step mb-3" wire:click="setStep(2)">
                  <i class="fa fa-share d-block d-md-none"></i> <span class="d-none d-md-block">{{trans("icommerce::checkout.tabs.next")}}</span>
                </button>
              @endauth
              @guest
                <div class="btn btn-light border font-weight-bold mb-3 start-step">{{trans("icommerce::checkout.alerts.login_order")}}
                </div>
              @endguest
            ...
            <div class="text-right">
              ...
              @auth
                <button type="button" class="btn btn-dark prev-step mb-3">
                  <i class="fa fa-reply d-block d-md-none"></i> <span class="d-none d-md-block" wire:click="setStep(1)">{{trans("icommerce::checkout.tabs.previous")}}</span>
                </button>
              
              @if($requireShippingMethod)
                <button type="button" class="btn btn-dark next-step mb-3">
                  <i class="fa fa-share d-block d-md-none"></i> <span class="d-none d-md-block" wire:click="setStep(3)">{{trans("icommerce::checkout.tabs.next")}}</span>
                </button>
              @endif
              @endauth
          ...
          <div class="tab-pane {{$step == 3 ? 'active' : ''}}" role="tabpanel" id="step3">
            ...
            <div class="text-right">
              ...
              @auth
                <button type="button" class="btn btn-dark prev-step mb-3">
                  <i class="fa fa-reply d-block d-md-none"></i> <span class="d-none d-md-block" wire:click="setStep(2)">{{trans("icommerce::checkout.tabs.previous")}}</span>
                </button>
              @endauth
