<div class="filter-range-prices mb-4" >
	...
	<div class="content position-relative my-3">
        ...
        <div class="collapse multi-collapse show mb-2" id="collapseRangePrices">
			...
			<button onClick="window.livewire.dispatch('updateRange',{'selPriceMin' : document.getElementById('selPriceMin').value,'selPriceMax' : document.getElementById('selPriceMax').value})" id="btnUpdatePrices" class="btn btn-outline-primary btn-sm btn-block mt-3">
