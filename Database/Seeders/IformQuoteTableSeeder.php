  ...
  public function run()
  {
    ...
    if(!isset($form->id)) {
      ...
      $form = $formRepository->create([
        "title" => trans("icommerce::quote.productForm.form.title"),
      ...
      $fieldRepository->create([
        ...
        "block_id" => $block->id,
        "es" => [
          "label" => trans("icommerce::quote.productForm.fields.phone.label",[],"es"),
        ],
        "en" => [
          "label" => trans("icommerce::quote.productForm.fields.phone.label",[],"en"),
        ],
        "type" => 10,
        "name" => "phone",
        "required" => true,
