...
class ProductLowStock
{
  ...
  \Log::info(trans("icommerce::products.messages.productLowStock",["units" => $this->product->quantity,"name" => $this->product->name]));
    ...
    $this->notificationService->to([
      ...
      [
        "title" => trans("icommerce::products.alerts.productLowStock"),
        "message" => trans("icommerce::products.messages.productLowStock",["units" => $this->product->quantity,"name" => $this->product->name]),
