...
class ProductOptionSoldOut
{
  ...
  public function notification()
  {
      ...
      $this->notificationService->to([
          ...
          [
              'title' => trans('icommerce::productoptions.alerts.soldOut'),
              'message' => trans('icommerce::productoptions.messages.soldOut', ['name' => $this->entity->optionValue->description, 'productName' => $this->product->name]),
