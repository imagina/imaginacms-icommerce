...
class ProductTransformer extends BaseApiTransformer
{
  ...
  public function toArray($request)
  {
    ...
    $data = [
      ...
      'weightClassId' => $this->when($this->weight_class_id, intval($this->weight_class_id)),
      'length' => $this->when($this->length, $this->length),
      'lengthClassId' => $this->when($this->length_class_id, intval($this->length_class_id)),
      ...
      'volume' => $this->when($this->volume, intval($this->volume)),
      'volumeClassId' => $this->when($this->volume_class_id, intval($this->volume_class_id)),
