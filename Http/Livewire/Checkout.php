...
class Checkout extends Component
{
    ...
    public function getBillingAddressProperty()
    {
        ...
        if (isset($billingAddress->id)) {
            $this->billingAddressSelected = $billingAddress->id;
        }
    ...
    public function getShippingAddressProperty()
    {
        ...
        if (isset($shippingAddress->id)) {
            $this->shippingAddressSelected = $shippingAddress->id;
        }
    ...
    public function getShippingMethodProperty()
    {
        ...
        if (isset($shippingMethod->id)) {
            $this->shippingMethodSelected = $shippingMethod->id;
        }
    ...
    public function submit(Request $request)
    {
        ...
        try {
            if ($this->shopAsGuest && ! empty($this->addressGuest)) {
                ...
                $billingAddressGuest = Address::create([
                ...
                if ($this->requireShippingMethod && ! $this->sameShippingAndBillingAddresses) {
                    $shippingAddressGuest = Address::create([
                        'user_id' => $this->user->id,
