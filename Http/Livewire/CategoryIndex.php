...
class CategoryIndex extends Component
{
  ...
  public function render()
  {
    ...
    $categories = $this->getCategoryRepository()->getItemsBy(json_decode(json_encode($this->makeParamsFunction())));

    return view($this->view, ['categories' => $categories, 'params' => $this->params]);
