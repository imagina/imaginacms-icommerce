<template>
    <carousel :scrollPerPage="true" :perPageCustom="[[0, 1], [480, 2], [768, 2]]" :autoplay="true" :speed="300" :loopenable="true">
            ...
            <div class="card card-product rounded-0 mt-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-md-center pb-4">
                       <span class="rating justify-content-md-center pb-4 text-center">
...
<script>
    export default {
        ...
        methods: {
            getData: function () {
                let uri = icommerce.url + '/api/icommerce/v2/products?filters={"recent":true,"take":5}';
                axios
                    .get(uri)
                    .then(response => {
